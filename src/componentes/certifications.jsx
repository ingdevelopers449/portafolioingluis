...
const certifications = [
  {
    title: "Ingeniería de Software con IA Generativa",
    issuer: "Fundación Escuela Tecnológica de Neiva — FET",
    year: "2026",
    icon: (
    ...
    tags: ["IA Generativa", "Machine Learning", "Prompting"],
    badge: "Completado"
  },
  {
    title: "Robótica Recreativa",
    issuer: "SENA — Servicio Nacional de Aprendizaje, Neiva",
    year: "2025",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    tags: ["Arduino", "Hardware", "Electrónica"],
    badge: "Completado"
  },
  {
    title: "Técnico en Sistemas",
    issuer: "I.E. Atanasio Girardot — Neiva, Huila",
    year: "2023",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    tags: ["Redes", "Mantenimiento PC", "Sistemas Operativos"],
